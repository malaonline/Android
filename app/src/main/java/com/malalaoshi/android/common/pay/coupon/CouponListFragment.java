package com.malalaoshi.android.common.pay.coupon;
...
import com.malalaoshi.android.common.pay.api.CouponListApi;
import com.malalaoshi.android.common.pay.api.CouponListMoreApi;
...
public class CouponListFragment extends BaseRefreshFragment<CouponResult> {
    ...
    private void initBundle() {
        ...
        setEmptyViewText(getString(R.string.not_have_coupon));
